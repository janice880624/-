function Window=creategridwindow(ratio,sizewidth,backgroundcolor,linewidth,outlinewidth,linecolor,gridnum,level)
...
if level<10
    window(round(5*sizeheight/12):round(5*sizeheight/12+sizenum(1)-1),...
        round(sizewidth/2-sizenum(2)/2):round(sizewidth/2+sizenum(2)/2-1))=numstruct(level).num;
else
    %clear the center px
    window(round(5*sizeheight/12):round(5*sizeheight/12+sizenum(1)-1),...
    ...
    window(round(5*sizeheight/12):round(5*sizeheight/12)+sizenum(1)-1,...
        ...
        =numstruct(fix(level/10)).num;
    countwindow=level-fix(level/10)*10;
    %set the right num
    if countwindow==0
        window(round(5*sizeheight/12):round(5*sizeheight/12)+sizenum(1)-1,...
