...
while loop==1
    ...
    if datascan=="Hard reset"
        ...
        projection_xy=zeros(size_robot_real(2),2);
        for i=1:size_robot_real(2)
        ...
        Player_projection_Object=imcrop(Player_projection_Object,[236 184 780-236 708-184]);
        ...
        Iplayerobject=imcrop(Iplayerobject,[236 184 780-236 708-184]);
        ...
        pause(2);
        % Show score point
        Pointwindow=createpointwindow(pointwindow,player_score,robot_score);
        imshow(Pointwindow);
        pause(2);
